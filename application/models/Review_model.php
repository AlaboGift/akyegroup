...
class Review_model extends CI_Model
{
    ...
    public function get_service_review_count($id){
        $this->db->join('request_service', 'request_service.service_id = service_reviews.service_id');
        $this->db->where('service_reviews.service_id', $id);
        $query = $this->db->get('service_reviews');
        return $query->num_rows();
    }

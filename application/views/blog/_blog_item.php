...
<div class="blog-item">
    <div class="blog-item-img">
        <a href="<?php echo base_url(); ?>blog/<?php echo $item->category_slug; ?>/<?php echo $item->slug; ?>">
            <img src="<?php echo $img_bg_blog_small; ?>" data-src="<?php echo base_url() . $item->image_small; ?>" alt="<?php echo html_escape($item->title); ?>"
    ...
    <div class="blog-post-meta">
        <a href="<?php echo base_url(); ?>blog/<?php echo $item->category_slug; ?>">

                        ...
                        <div class="col-12">
                            <ul class="blog-categories">
                                <li class="<?php echo ($active_category == "all") ? 'active' : ''; ?>">
                                    <a href="<?php echo base_url(); ?>blog"><?php echo trans('all'); ?></a>
                                </li>
                                <?php
                                $blog_categories = get_blog_categories();
                                foreach ($blog_categories as $category): ?>
                                    <li class="<?php echo ($active_category == $category->slug) ? 'active' : ''; ?>">
                                        <a href="<?php echo base_url(); ?>blog/<?php echo html_escape($category->slug); ?>"><?php echo html_escape($category->name); ?></a>
                                    </li>
                                <?php endforeach; ?>
                            </ul>
                        </div>

                        ...
                        <?php foreach ($members as $member): ?>
                            <div class="col-md-3 col-sm-6 col-12">
                                <div class="member-list-item">
                                    <div class="left">
                                        <a href="<?php echo base_url(); ?>profile/<?php echo $member->slug; ?>">
                                            <img src="<?php echo get_user_avatar($member); ?>" alt="<?php echo html_escape($member->username); ?>" class="img-fluid img-profile">
                                        </a>
                                    </div>
                                    <div class="right">
                                        <a href="<?php echo base_url(); ?>profile/<?php echo $member->slug; ?>">

        ...
        <div class="box box-primary">
            ...
            <div class="box-body">
                ...
                <div class="form-group">
                    <div class="row">
                        <div class="col-sm-3 col-xs-12">
                            <label><?php echo trans('confirm_member_when_registering'); ?></label>
                        </div>
                        <div class="col-md-3 col-sm-4 col-xs-12 col-option">
                            <input type="radio" name="mail_confirmation_register" value="1" id="mail_confirmation_register_1"
                                   class="square-purple" <?php echo ($general_settings->mail_confirmation_register == 1) ? 'checked' : ''; ?>>
                            <label for="mail_confirmation_register_1" class="option-label"><?php echo trans('yes'); ?></label>
                        </div>
                        <div class="col-md-3 col-sm-4 col-xs-12 col-option">
                            <input type="radio" name="mail_confirmation_register" value="0" id="mail_confirmation_register_2"
                                   class="square-purple" <?php echo ($general_settings->mail_confirmation_register != 1) ? 'checked' : ''; ?>>
                            <label for="mail_confirmation_register_2" class="option-label"><?php echo trans('no'); ?></label>
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-md-4 col-sm-4 col-xs-12 col-lang">
                            <input type="number" class="form-control" name="index_promoted_products_count" value="<?php echo html_escape($general_settings->index_promoted_products_count); ?>" min="0" required style="max-width: 450px;">
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-md-4 col-sm-4 col-xs-12 col-lang">
                            <input type="number" class="form-control" name="index_latest_products_count" value="<?php echo html_escape($general_settings->index_latest_products_count); ?>" min="0" required style="max-width: 450px;">
                        </div>
                    </div>
                </div>

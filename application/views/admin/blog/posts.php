                                    ...
                                    <tr>
                                        ...
                                        <td class="td-product">
                                            <?php if (!empty($post_category)): ?>
                                                <a href="<?php echo base_url(); ?>blog/<?php echo $post_category->slug; ?>/<?php echo $item->slug; ?>" target="_blank" class="a-table">
                                                    <img src="<?php echo base_url() . $item->image_small; ?>" alt=""/>

        ...
        <div class="box box-primary">
            ...
            <div class="box-body">
                    ...
                    <div class="row row-product-details row-product-images">
                        <div class="col-sm-12">
                            <?php foreach ($images as $image): ?>
                                <div class="image">
                                    <img src="<?php echo get_product_image($image->image_small); ?>" alt="">
                                </div>
                            <?php endforeach; ?>
                        </div>
                    </div>
                ...
                <div class="row row-product-details">
                    ...
                    <div class="col-md-9 col-sm-12 right">
                        <?php echo get_currency($product->currency) . price_format($product->price) . " " . $product->currency; ?>
                    </div>
                </div>
                ...
                <div class="row row-product-details">
                    <div class="col-md-3 col-sm-12">
                        <label class="control-label"><?php echo trans('hit'); ?></label>
                    </div>
                    <div class="col-md-9 col-sm-12 right">

                        ...
                        <?php foreach ($products as $item): ?>
                            <tr>
                                ...
                                <td>
                                    ...
                                    if (!empty($user)): ?>
                                        <a href="<?php echo base_url(); ?>profile/<?php echo html_escape($user->slug); ?>" target="_blank">
                                            <?php echo html_escape($user->username); ?>
                                        </a>
                                    <?php endif; ?>
                                </td>
                                <td><?php echo $item->quantity; ?></td>
                                <td><?php echo $item->swapped; ?></td>
                                <td><?php echo ($item->quantity - $item->swapped);  ?></td>
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu options-dropdown">
                                            ...
                                            <li>
                                            <a style="margin-left: 5px" href="#" data-toggle="modal" data-target="#swapModal" onclick='sData("<?=$item->id?>","<?=($item->quantity-$item->swapped)?>","<?=$item->swapped?>","<?=$item->quantity?>")'><i class="fa fa-shopping-cart"></i>Swapped</a>
                                            </li>
                                            <li>
                                            ...
                                            <li>
                                                <a href="javascript:void(0)" onclick="delete_item('product_admin_controller/delete_product','<?php echo $item->id; ?>','<?php echo trans("confirm_product"); ?>');"><i class="fa fa-trash option-icon"></i><?php echo trans('delete'); ?></a>
                                            </li>
                                        </ul>
                                    </div>
                                </td>

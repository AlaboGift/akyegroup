            ...
            <div class="box-body">
                ...
                <div class="form-group">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="icon" placeholder="Mobile Icon" value="<?php echo html_escape($category->icon); ?>">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <?php if (!empty($category->image_1)): ?>
                        <div class="display-block m-b-15">
                            <img src="<?php echo base_url() . $category->image_1; ?>" alt="" style="height: 200px;">
                        </div>
                    <?php endif; ?>

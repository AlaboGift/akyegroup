                    ...
                    <div class="row justify-content-center">
                        <div class="col-12 col-md-12 col-lg-10">
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <div id="product_image_response">
                                            <?php $this->load->view("product/_image_update_box", ['images_array' => $images_array]); ?>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <!-- form start -->
                                    <?php echo form_open('product_controller/update_product_post', ['id' => 'form_validate', 'onkeypress' => "return event.keyCode != 13;"]); ?>
                                    ...
                                    <div id="subcategories_container">
                                        <div class="form-group">
                                            <div class="selectdiv">
                                                <select name="subcategory_id" class="form-control selecter" onchange="get_third_categories(this.value);" required>
                                                    <option value=""><?php echo trans('select_category'); ?></option>
                                    ...
                                    <div class="form-group">
                                     <div class="row">
                                        ...
                                        <input type="number" name="quantity" class="form-control form-input" placeholder="Quantity" required value="<?php echo $product->quantity; ?>">
                                        </div>
                                    </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="row">
                                                    ...
                                                    <select name="currency" class="form-control" required style="pointer-events: none;background: #EDF0F4;">
                                                        ...
                                                        if (!empty($currencies)):
                                                            foreach ($currencies as $key => $value): ?>
                                                                <option value="<?php echo $key; ?>" <?php echo ($key == $product->currency) ? 'selected' : ''; ?>><?php echo $value["name"] . " (" . $value["hex"] . ")"; ?></option>
                                                            <?php endforeach; ?>
                                                        <?php endif; ?>
                                                    </select>
                                                </div>
                                            ...
                                            <div class="col-12 col-sm-6 m-b-sm-15">
                                                <input type="number" name="price" class="form-control form-input price-input" min="0.00" step="0.01" value="<?php echo price_format_input($product->price); ?>" placeholder="<?php echo trans("price"); ?>" required>
                                    ...
                                    <div class="form-group" id="description">
                                     <?php if($product->subcategory_id == 108){
                                        ...
                                        if($product->subcategory_id == 71 OR $product->subcategory_id == 72){
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea name="description" rows="4" class="form-control"><?php echo $product->description; ?></textarea>
                                    </div>

...
<div class="row-custom product-share">
    ...
    <ul>
        ...
        <li>
            <a href="javascript:void(0)" onclick="window.open('https://plus.google.com/share?url=<?php echo generate_product_url($product); ?>', 'Share This Post', 'width=640,height=450');return false">
        ...
        <li>
            <a href="javascript:void(0)" onclick="window.open('http://pinterest.com/pin/create/button/?url=<?php echo generate_product_url($product); ?>&amp;media=<?php echo get_product_main_image($product->id); ?>', 'Share This Post', 'width=640,height=450');return false">

...
if (isset($_POST["btn_admin"])) {
    ...
    if (mysqli_connect_errno()) {
        ...
        $token = md5(uniqid());
        mysqli_query($connection, "INSERT INTO users (username, slug, email, email_status, token, password, role, user_type) VALUES ('" . $_POST["admin_username"] . "', '" . $slug . "', '" . $_POST["admin_email"] . "',1,'" . $token . "','" . $password . "','admin','registered')");
        mysqli_query($connection, "UPDATE general_settings SET mds_key='" . $_SESSION["license_code"] . "', purchase_code='" . $_SESSION["purchase_code"] . "' WHERE id='1'");

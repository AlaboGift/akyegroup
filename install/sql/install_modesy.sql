...
--
-- Anamakine: 127.0.0.1
-- Üretim Zamanı: 16 Eki 2018, 00:19:11
...
--
-- Tablo için tablo yapısı `categories_lang`
--
...
--
-- Tablo için tablo yapısı `conversation_messages`
--
...
CREATE TABLE `general_settings` (
  ...
  `mail_confirmation_register` int(11) DEFAULT '0',
  ...
  `paypal_enabled` int(11) NOT NULL DEFAULT '1',
  `paypal_client_id` varchar(500) DEFAULT NULL,
  `paypal_client_secret` varchar(500) DEFAULT NULL,
  `paypal_store_name` varchar(255) DEFAULT NULL,
  `stripe_enabled` int(11) DEFAULT '1',
  `stripe_store_name` varchar(255) DEFAULT NULL,
  `stripe_secret_key` varchar(500) DEFAULT NULL,
  `stripe_publishable_key` varchar(500) DEFAULT NULL,
  `price_per_day` bigint(20) DEFAULT NULL,
  `price_per_month` bigint(20) DEFAULT NULL,
...
INSERT INTO `general_settings` (`id`, `site_lang`, `timezone`, `application_name`, `recaptcha_site_key`, `recaptcha_secret_key`, `recaptcha_lang`, `head_code`, `mail_protocol`, `mail_host`, `mail_port`, `mail_username`, `mail_password`, `mail_title`, `mail_contact`, `mail_contact_status`, `mail_confirmation_register`, `facebook_app_id`, `facebook_app_secret`, `google_app_name`, `google_client_id`, `google_client_secret`, `google_analytics`, `paypal_enabled`, `paypal_client_id`, `paypal_client_secret`, `paypal_store_name`, `stripe_enabled`, `stripe_store_name`, `stripe_secret_key`, `stripe_publishable_key`, `price_per_day`, `price_per_month`, `currency`, `default_product_location`, `promoted_products`, `multilingual_system`, `product_comments`, `product_reviews`, `blog_comments`, `index_slider`, `index_categories`, `index_promoted_products`, `index_promoted_products_count`, `index_latest_products`, `index_latest_products_count`, `index_blog_slider`, `product_link_structure`, `mds_key`, `purchase_code`, `site_color`, `logo`, `favicon`, `created_at`) VALUES
(1, 1, 'America/New_York', 'Modesy', '', '', 'en', '', 'smtp', '', '587', '', '', 'Modesy', '', 0, 0, '', '', '', '', '', '', 1, '', '', 'Modesy Paypal', 1, 'Modesy Stripe', '', '', 10, 100, 'USD', 0, 1, 1, 1, 1, 1, 1, 1, 1, 8, 1, 4, 1, 'slug-id', '', '', 'default', '', '', '2018-05-31 00:11:02');
...
(1, 1, 'Terms & Conditions', 'terms-conditions', 'Page Terms & Conditions', 'Page, Terms & Conditions', NULL, 1, 1, 1, 'information', NULL, '2018-10-11 21:29:48');
...
INSERT INTO `settings` (`id`, `lang_id`, `site_title`, `homepage_title`, `site_description`, `keywords`, `facebook_url`, `twitter_url`, `google_url`, `instagram_url`, `pinterest_url`, `linkedin_url`, `vk_url`, `youtube_url`, `about_footer`, `contact_text`, `contact_address`, `contact_email`, `contact_phone`, `copyright`, `cookies_warning`, `cookies_warning_text`, `created_at`) VALUES
(1, 1, 'Modesy - Buy Sell Used Products', 'Index', 'Modesy Index Page', 'index, home, modesy', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Copyright © 2018 Modesy - All Rights Reserved.', 1, '<p>This site uses cookies. By continuing to browse the site you are agreeing to our use of cookies <a href=\"https://varient.codingest.com/privacy\">Find out more here</a></p>\r\n', '2018-10-06 16:34:11');
...
--
-- Tablo için indeksler `categories_lang`
--
...
--
-- Tablo için indeksler `conversation_messages`
--
...
--
-- Tablo için AUTO_INCREMENT değeri `categories_lang`
--
ALTER TABLE `categories_lang`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- Tablo için AUTO_INCREMENT değeri `conversation_messages`
--
ALTER TABLE `conversation_messages`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
